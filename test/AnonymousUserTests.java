...
public class AnonymousUserTests {
    ...
    void anonymousGetAssignments() {
        ...
        LMS lms = new LMS();
        String username = "john_doe";
        lms.uploadAssignment(username, "Assignment 6");
        assertEquals("{john_doe=Assignment 6}", lms.getAssignments().toString());
    ...
    void anonymousAcademicCalendar() {
        ...
        LMS lms = new LMS();
        String username = "john_doe";
        lms.addEventToCalendar("2024-06-03", "A really great event");
        assertEquals("{2024-06-03=A really great event}", lms.getAcademicCalendar().toString());
    ...
    void anonymousCourseMaterials() {
        ...
        LMS lms = new LMS();
        String username = "john_doe";
        lms.addCourseMaterial("Excellent course material");
        assertEquals("[Excellent course material]", lms.getCourseMaterials().toString());
